...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadEntries() {
        ...
        chrome.storage.local.get([`manualEntries_${dateKey}`], (data) => {
    ...
    function saveEntries(entries) {
        const dateKey = getTodayKey();
        chrome.storage.local.set({ [`manualEntries_${dateKey}`]: entries }, () => {
    ...
    function updateSummary(entries) {
        ...
        chrome.storage.local.get(['maxWorkHours', 'maxWorkMinutes'], (settings) => {
            ...
            if (remainingSeconds > 0) {
                ...
                chrome.storage.local.get(['enable24HourClock'], (data) => {
